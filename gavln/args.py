...
class ModelArguments:
    ...
    bev_grid_size: Optional[float] = field(default=0.25)
    bev_range: Optional[float] = field(default=10.0)
    bev_pos_temp: Optional[float] = field(default=10000)
...
class DataArguments:
    ...
    bev_num_steps: Optional[int] = field(default=4)
    bev_max_steps: Optional[int] = field(default=32)
    dia_round: Optional[int] = field(default=2)
    num_front_view: Optional[int] = field(default=1)
